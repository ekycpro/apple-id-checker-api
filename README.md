# Apple Checker API — official examples | eKYC Pro

This repository documents the eKYC Pro Apple Checker API integration contract using facts from the expansion manifest.

- Product page: https://ekycpro.com/tools/apple
...
```bash
curl -X POST "https://api.ekycpro.com/v1/check" -H "X-API-Key: ${EKYCPRO_API_KEY}" -H "Content-Type: application/json" -d '{"service_type":"apple","identifier":"+14155550100"}'
```
...
| --- | --- | --- | --- | --- | --- |
| `apple` | Apple Checker | phone | 1–1 identifier | `id, identifier, registered, billed, cost, cost_usd` | [docs](https://docs.ekycpro.com/apple-number-checker) |
| `apple_email` | Apple Email Checker | email | 1–1 identifier | `id, identifier, registered, billed, cost, cost_usd` | [docs](https://docs.ekycpro.com/apple-email-checker) |
...
- `apple`: https://docs.ekycpro.com/apple-number-checker
- `apple_email`: https://docs.ekycpro.com/apple-email-checker
